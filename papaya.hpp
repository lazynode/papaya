...
class Mark : public base::Base
{
public:
  Mark(const std::string tag)
  {
    (*this)["$nodename$"] = "AssemblyPlaceMark";
    (*this)["tag"] = tag;
  }
};
...
public:
  DOWHILE(uint8_t tagsize, const base::Expr cond, std::initializer_list<const base::Stmt> children)
  {
    ...
    if (tagsize == 0 || tagsize > 4)
    {
      std::cerr << "[DOWHILE]: invalid tagsize: " << tagsize << std::endl;
      tagsize = 2;
    }
    (*this)["tagsize"] = tagsize;
    (*this)["$children$"] = Json::Value(Json::arrayValue);
...
public:
  UNLESS(uint8_t tagsize, const base::Expr cond, std::initializer_list<const base::Stmt> children)
  {
    ...
    if (tagsize == 0 || tagsize > 4)
    {
      std::cerr << "[UNLESS]: invalid tagsize: " << tagsize << std::endl;
      tagsize = 2;
    }
    (*this)["tagsize"] = tagsize;
    (*this)["$children$"] = Json::Value(Json::arrayValue);
...
public:
  IF(uint8_t tagsize, const base::Expr cond, std::initializer_list<const base::Stmt> children)
  {
    ...
    if (tagsize == 0 || tagsize > 4)
    {
      std::cerr << "[IF]: invalid tagsize: " << tagsize << std::endl;
      tagsize = 2;
    }
    (*this)["tagsize"] = tagsize;
    (*this)["$children$"] = Json::Value(Json::arrayValue);
...
public:
  WHILE(uint8_t tagsize, const base::Expr cond, std::initializer_list<const base::Stmt> children)
  {
    ...
    if (tagsize == 0 || tagsize > 4)
    {
      std::cerr << "[WHILE]: invalid tagsize: " << tagsize << std::endl;
      tagsize = 2;
    }
    (*this)["tagsize"] = tagsize;
    (*this)["$children$"] = Json::Value(Json::arrayValue);
...
class Contract : public base::Base
{
public:
  Contract(uint8_t tagsize, std::initializer_list<const base::Stmt> init, std::initializer_list<const base::Stmt> body)
  {
    (*this)["$nodename$"] = "BasicContractConstructor";
    (*this)["$children$"] = Json::Value(Json::arrayValue);
    if (tagsize == 0 || tagsize > 4)
    {
      std::cerr << "[Contract]: invalid tagsize: " << tagsize << std::endl;
      tagsize = 2;
    }
    (*this)["tagsize"] = tagsize;
    for (auto child : init)
...
classdef::Mark Mark(const std::string tag)
{
  return classdef::Mark(tag);
}
...
classdef::Contract Contract(uint8_t tagsize, std::initializer_list<const classdef::base::Stmt> init, std::initializer_list<const classdef::base::Stmt> body)
{
  return classdef::Contract(tagsize, init, body);
}
classdef::Contract Contract(std::initializer_list<const classdef::base::Stmt> init, std::initializer_list<const classdef::base::Stmt> body)
{
  return classdef::Contract(2, init, body);
}
classdef::Contract Contract(uint8_t tagsize, std::initializer_list<const classdef::base::Stmt> body)
{
  return classdef::Contract(tagsize, {}, body);
}
classdef::Contract Contract(std::initializer_list<const classdef::base::Stmt> body)
{
  return classdef::Contract(2, {}, body);
}
